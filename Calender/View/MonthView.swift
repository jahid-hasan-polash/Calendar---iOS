...
class MonthView: UIView {
    ...
    func setupViews() {
        ...
        btnRight.widthAnchor.constraint(equalToConstant: UIDevice.current.userInterfaceIdiom == .pad ? 60 : 40).isActive=true
        btnRight.heightAnchor.constraint(equalToConstant: UIDevice.current.userInterfaceIdiom == .pad ? 60 : 40).isActive=true
        ...
        btnLeft.widthAnchor.constraint(equalToConstant: UIDevice.current.userInterfaceIdiom == .pad ? 60 : 40).isActive=true
        btnLeft.heightAnchor.constraint(equalToConstant: UIDevice.current.userInterfaceIdiom == .pad ? 60 : 40).isActive=true
    ...
    let lblName: UILabel = {
        ...
        lbl.font=CustomSetup.boldLabelFont
